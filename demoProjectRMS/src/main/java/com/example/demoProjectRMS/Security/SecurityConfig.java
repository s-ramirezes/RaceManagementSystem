package com.example.demoProjectRMS.Security;

import com.example.demoProjectRMS.Employee.CustomEmployeeDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers("/strategy/**").hasAuthority("ENGINEER")
                        .requestMatchers("/live_feedback/**").hasAuthority("ENGINEER")
